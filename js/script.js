...
//este evento verifica que este todo cargado
...
const renderTareas = () => {
    ...
    <td>
        ...
        <button type="button" onclick="editarTarea(${tarea.id})">Editar</button>
        <button type="button" onclick="borrarTarea(${tarea.id})">Borrar</button>
    </td>
</tr>
`)
    );
